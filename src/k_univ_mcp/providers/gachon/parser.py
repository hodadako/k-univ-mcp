...
from k_univ_mcp.semester import semester_display_label
...
def build_course(
    ...
    *,
    ...
    return Course(provider="gachon",
    year=year, semester_code=semester, semester_name=row.payload.get("TERM_NM") or semester_display_label(semester),
