...
def _course_from_dict(payload: dict[str, Any]) -> Course:
    ...
    return Course(provider=payload["provider"],
    year=payload["year"], semester_code=payload.get("semester_code") or payload["semester"], semester_name=payload.get("semester_name"),
